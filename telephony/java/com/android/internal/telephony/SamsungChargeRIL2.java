...
public class SamsungChargeRIL2 extends RIL implements CommandsInterface {

    public SamsungChargeRIL2(Context context, int networkMode, int cdmaSubscription) {
    ...
    responseSignalStrength(Parcel p) {
        ...
        // SamsungChargeRIL2 is a v3 RIL, fill the rest with -1
